...
public interface TrackBuilder {
     ...
     */
    void startNewTrack(String name, String type);
     ...
     */
    void addFeatures(Iteratable<Feature> features);
     ...
     */
    void applySequenceMapper(SequenceMapper<String> mapper);

    /**
     * Transform features by mapping feature names to coordinates on the genome.
     */
    void applyCoordinateMapper(CoordinateMapper mapper);
