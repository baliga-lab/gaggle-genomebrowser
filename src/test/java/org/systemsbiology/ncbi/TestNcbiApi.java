...
public class TestNcbiApi {
    ...
    // TODO: Test will fail -> leuks.cgi is broken !!
    @Test
    public void testRetrieveProkaryoticGenomeProjects() throws Exception {
        ...
        //for (ProkaryoticGenomeProjectSummary project : projects) System.out.println(project);
    ...
    public void testRetrieveSequencedOrganisms() throws Exception {
        ...
        //for (NcbiGenomeProjectSummary no : organisms) System.out.println(no);
