...
public enum Category {
	all, virus, archaea, bacteria, prokaryotes, eukaryotes, deuterostome, insect, mammal, vertebrate, worm, yeast;
	...
	public boolean isEukaryotic() {
		return (this==eukaryotes || this==deuterostome || this==insect || this==mammal || this==vertebrate
	...
	public boolean isA(Category other) {
		...
		if (other == eukaryotes) {
			return (this==deuterostome || this==insect || this==mammal || this==vertebrate
					|| this==worm || this==yeast);
		}
		return false;
	}
