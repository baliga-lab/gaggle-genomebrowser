...
public class Genome {
	...
	public Genome(String dbName, String description, String genome, String scientificName, long taxid, String clade, String domain) {
		this.dbName = dbName;
	...
	public Category getCategory() {
		return Category.fromDomainAndClade(domain, clade);
	}
