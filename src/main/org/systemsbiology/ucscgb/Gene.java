...
public class Gene {
	...
	public String toString() {
		return String.format("(Gene: name=%s, name2=%s, type=%s, chr=%s, %s, coords=(%,d-%,d))", name, name2, geneType, chrom, strand, cdsStart, cdsEnd);
	}

	public Gene(
			String name, String chrom, String strand,
			int txStart, int txEnd,
			int cdsStart, int cdsEnd,
			int exonCount, String exonStarts, String exonEnds,
			String id, String name2,
			String cdsStartStat, String cdsEndStat, String exonFrames, String type) {
		this.name = name;
		this.chrom = chrom;
		this.strand = strand;
