...
public enum Strand {
	...
	public static Strand fromString(String s) {
		if (s == null || "".equals(s))
			return none;
		s = s.toLowerCase();
		if ("for".equals(s) || "+".equals(s) || "forward".equals(s)) {
			return forward;
		}
		if ("rev".equals(s) || "-".equals(s) || "reverse".equals(s)) {
			return reverse;
		}
		if (".".equals(s) || "none".equals(s))
			return none;
		if ("*".equals(s) || "any".equals(s))
			return any;
		try {
	...
	public boolean encompasses(Strand strand) {
		return (this==strand || this==Strand.any);
	}
