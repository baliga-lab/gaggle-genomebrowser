...
//			System.out.println("-------------------------------------------------------------------");
	...
	public void draw(Graphics g, Iterable<? extends Feature> features, Strand strand) {
		...
		Iterable<Feature.Matrix> matrixFeatures = (Iterable<Feature.Matrix>)features;
...
//		}
		...
		if (dataPointsPerPixel >= 4.0) {
			...
			for (Feature.ScaledQuantitative feature : new ScalingQuantitativeMatrixIteratable(matrixFeatures, blockSize)) {
