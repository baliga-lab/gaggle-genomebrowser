...
public class Bookmark implements Feature {
	...
	public Bookmark(String seqId, Strand strand, int start, int end, String label, String annotation) {
		this.seqId = seqId;
		this.start = start;
		this.end = end;
		this.strand = strand;
	...
	public Bookmark(String seqId, Strand strand, int start, int end, String label, String annotation, String attributes) {
		this.seqId = seqId;
		this.start = start;
		this.end = end;
		this.strand = strand;
	...
	public Bookmark(String seqId, Strand strand, int start, int end, String label, String annotation, String attributes, String sequence) {
		this.seqId = seqId;
		this.strand = strand;
		this.start = start;
		this.end = end;
...
//		// TODO fix copy bookmarks if used
...
//	}
	...
	public Strand getStrand() {
		return strand==null ? Strand.none : strand;
	}
	...
	public boolean equals(Object obj) {
		...
		if (annotation == null) {
			...
			return false;
		if (!Arrays.equals(associatedFeatureName, other.associatedFeatureName))
			return false;
		if (end != other.end)
			return false;
		if (label == null) {
	...
	public String toString() {
		return label!=null ? label : String.format("%s%s:%d-%d", seqId, strand.toAbbreviatedString(), start, end);
	}
}
